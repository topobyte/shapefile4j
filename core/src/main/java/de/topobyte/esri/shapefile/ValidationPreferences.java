...
import de.topobyte.esri.shapefile.shape.PartType;
...
public class ValidationPreferences
{
	...
	/**
	 * Allows any (positive) number of points per shape. It's strongly advised
	 * to always limit the number of points per shape; otherwise, a corrupt file
	 * with a gigantic (garbage) number of points may crash the reader with an
